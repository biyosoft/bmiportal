    ...
    <div class="mx-5 mt-3" style="float:right !important;">
      <ul class="">
        <li class="nav-item dropdown  d-flex align-items-center ">
          ...
          <span style="background-color: #009fe3 ;" class="badge  text-white badge-sm m-1"><span id="msg"></span></span>
              ...
              <div style="min-width: 300px; padding:10px;">
                <div class="d-flex flex-column justify-content-center">
                  <h6 class="text-sm font-weight-normal mb-0">
                    <span class="font-weight-bold active "><b> <a href="">Shahzaib</a>
                  ...
                  <p class="text-xs text-secondary mb-0 mt-1">
                    ...
                    23:324:1234
                    <input class="notification_id" type="hidden" name="notification_id" value="" id="">
            ...
            <div class="col-lg-12 col-sm-6">
              <div class="card mt-4">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-4">
                      <img src="{{asset('assets/img/kal-visuals-square.jpg')}}" alt="kal" class="border-radius-lg shadow w-100">
                    </div>
