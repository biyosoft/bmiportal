        ...
        <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-7">CN Number</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="mx-3">
                      <div class="flex-column ">
                        <p class="text-xs text-secondary mb-0">{{$creditnote->cn_date->format('d/m/y')}}</p>
                      </div>
                    </div>
                  </td>
                  <td>
                  ...
                  <div class="dropdown" >
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li><a class="dropdown-item" href="{{route('creditnotes.show',$creditnote->id)}}">View</a></li>
                        <li><a class="dropdown-item" href="{{route('creditnotes.edit',$creditnote->id)}}">Edit</a></li>
                        <li>
                          <form action="{{route('creditnotes.destroy',$creditnote->id)}}" method="post">
                            @csrf
                            @method('delete')
