        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="{{asset('soft-theme/pages/authentication/signin/illustration.html')}}" class="nav-link text-body font-weight-bold px-0" target="_blank">
              ...
              <ul class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="{{asset('soft-theme/assets/img/team-2.jpg')}}" class="avatar avatar-sm  me-3 " alt="user image">
                      </div>
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="{{asset('soft-theme/assets/img/small-logos/logo-spotify.svg')}}" class="avatar avatar-sm bg-gradient-dark  me-3 " alt="logo spotify">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
      ...
      <div class="row">
        ...
        <div class="col-xl-4 col-lg-5 mt-lg-0 mt-4">
          <div class="row">
            <div class="col-lg-12">
              <div class="card p-3">
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('{{asset('soft-theme    /assets/img/ivancik.jpg')}}')">
            ...
            <div class="col-lg-12 col-sm-6">
              <div class="card mt-4">
                <div class="card-body p-3">
                  <div class="row">
                    <div class="col-4">
                      <img src="{{asset('soft-theme/assets/img/kal-visuals-square.jpg')}}" alt="kal" class="border-radius-lg shadow w-100">
                    </div>
