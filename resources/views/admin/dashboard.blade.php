                  ...
                  <li class="nav-item dropdown  d-flex align-items-center ">
                    ...
                    <ul style="min-width: 270px;" class="dropdown-menu dropdown-menu-end px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                      @if(Auth::guard('admin')->check())
                                    ...
                                    <div style="min-width: 300px; padding:10px;">
                                      <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-xs text-secondary mb-0 mt-1">
                                          ...
                                          <a onclick="readNotfication();" style="margin-left: 15px;" href="javascript:void(0);" class="text-xs text-dark mb-0" id="enevelope"><i class="far fa-envelope-open"></i></a>
                                        </p>
                                      </div>
                                    </div>
                                  </a>
                              ...
                              @elseif($admin->unreadnotificaions)
...
@section('scripts')
<script>
         function readNotfication() {
          var id = $('[name="notification_id"]').val();
            $.ajax({
               type:'GET',
               url:'/markasred/'+id,
